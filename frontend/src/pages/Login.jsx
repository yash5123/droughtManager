...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 font-inter flex items-center justify-center p-4 selection:bg-blue-500/30">
      <div className="w-full max-w-[440px] bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-8 sm:p-10 relative overflow-hidden flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">
        
        {/* Subtle top glow */}
        <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-blue-500/30 to-transparent" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-32 bg-blue-500/10 rounded-full blur-[50px] pointer-events-none" />

        {/* Logo Area */}
        <div className="mb-8 flex flex-col items-center relative z-10">
           <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-b from-slate-800 to-slate-800/50 border border-slate-700/50 rounded-[20px] shadow-inner mb-6">
              <Droplet className="w-8 h-8 text-blue-400 fill-blue-500/20" strokeWidth={2} />
           </div>
           
           <h3 className="text-slate-400 font-medium tracking-widest text-[11px] uppercase mb-2">Welcome to</h3>
        ...
        <div className="w-full relative z-10">
          {error && (
            <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 text-red-400 text-sm rounded-xl flex items-center gap-3 animate-shake">
          ...
          {successMessage && (
            <div className="mb-6 p-4 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-sm rounded-xl flex items-center gap-3 animate-in slide-in-from-top-2">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    type="text"
                    required
                    className="w-full pl-10 pr-4 py-3 bg-slate-950 border border-slate-800 rounded-xl focus:ring-1 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none transition-all placeholder:text-slate-600 text-slate-200 text-sm"
